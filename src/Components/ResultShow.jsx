    ...
    return (
        <Container className="my-4 scholarship-container">
            ...
            <Card className="scholarship-card shadow-lg p-3" id="print-area">
                ...
                {/* ===== TITLE ===== */}
                <h5 className="scholarship-title bg-success text-white"> RESULT</h5>
                    ...
                    <Col md={8}>
                        <Table bordered responsive className="scholarship-table">
                            <tbody>
                                ...
                                <tr><td>Subject Wise</td><td>Fundamental Computer</td>
                                    <td>Ms Word</td><td>Ms Excel</td><td>Adobe Photoshop</td>
                                </tr>

                                <tr><td>Marks</td><td>30 / 50</td><td>30 / 50</td><td>30 / 50</td><td>30 / 50</td></tr>
                                <tr><td>Obtain Marks</td><td>120</td></tr>
